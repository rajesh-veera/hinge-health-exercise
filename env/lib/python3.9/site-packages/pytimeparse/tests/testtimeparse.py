...
class TestTimeparse(unittest.TestCase):
    ...
    def test_mins(self):
        ...
        self.assertEqual(re.match(timeparse.MINS, "32min").groupdict(), {"mins": "32"})
        self.assertEqual(re.match(timeparse.MINS, "32mins").groupdict(), {"mins": "32"})
        self.assertEqual(
            re.match(timeparse.MINS, "32minute").groupdict(), {"mins": "32"}
        )
        self.assertEqual(
            re.match(timeparse.MINS, "32minutes").groupdict(), {"mins": "32"}
        )
        self.assertEqual(re.match(timeparse.MINS, "32mins").groupdict(), {"mins": "32"})
        self.assertEqual(re.match(timeparse.MINS, "32min").groupdict(), {"mins": "32"})
    ...
    def test_hrs(self):
        """Test parsing hours."""
        self.assertEqual(re.match(timeparse.HOURS, "32h").groupdict(), {"hours": "32"})
        self.assertEqual(re.match(timeparse.HOURS, "32hr").groupdict(), {"hours": "32"})
        self.assertEqual(
            re.match(timeparse.HOURS, "32hrs").groupdict(), {"hours": "32"}
        )
        self.assertEqual(
            re.match(timeparse.HOURS, "32hour").groupdict(), {"hours": "32"}
        )
        self.assertEqual(
            re.match(timeparse.HOURS, "32hours").groupdict(), {"hours": "32"}
        )
        self.assertEqual(
            re.match(timeparse.HOURS, "32 hours").groupdict(), {"hours": "32"}
        )
        self.assertEqual(re.match(timeparse.HOURS, "32 h").groupdict(), {"hours": "32"})

    def test_time(self):
        """Test parsing time expression."""
        self.assertGreater(
            set(
                re.match(timeparse.TIMEFORMATS[0] + r"\s*$", "16h32m64s  ")
                .groupdict()
                .items()
            ),
    ...
    def test_timeparse_multipliers(self):
        ...
        self.assertEqual(timeparse.timeparse("32 min"), 1920)
        self.assertEqual(timeparse.timeparse("1 min"), 60)
        self.assertEqual(timeparse.timeparse("1 hours"), 3600)
        self.assertEqual(timeparse.timeparse("1 day"), 86400)
    ...
    def test_timeparse_10(self):
        ...
        self.assertAlmostEqual(timeparse.timeparse("2:04:13:02.266"), 187982.266)
        self.assertAlmostEqual(timeparse.timeparse("+2:04:13:02.266"), 187982.266)
        self.assertAlmostEqual(timeparse.timeparse("-2:04:13:02.266"), -187982.266)
    ...
    def test_timeparse_granularity_2(self):
        ...
        self.assertEqual(
            timeparse.timeparse("4:32:02", granularity="minutes"), 272 * 60 + 2
        )
        self.assertEqual(
            timeparse.timeparse("+4:32:02", granularity="minutes"), 272 * 60 + 2
        )
    ...
    def test_timeparse_granularity_3(self):
        ...
        self.assertAlmostEqual(
            timeparse.timeparse("7:02.223", granularity="minutes"), 7 * 60 + 2.223
        )
        self.assertAlmostEqual(
            timeparse.timeparse("+7:02.223", granularity="minutes"), 7 * 60 + 2.223
        )
    ...
    def test_timeparse_12(self):
        ...
        self.assertAlmostEqual(timeparse.timeparse("2 days,  4:13:02.266"), 187982.266)
        self.assertAlmostEqual(timeparse.timeparse("+2 days,  4:13:02.266"), 187982.266)
        self.assertAlmostEqual(
            timeparse.timeparse("-2 days,  4:13:02.266"), -187982.266
        )
    ...
    def test_timeparse_14(self):
        ...
        self.assertEqual(timeparse.timeparse("5 hours, 34 minutes, 56 seconds"), 20096)
        self.assertEqual(timeparse.timeparse("+5 hours, 34 minutes, 56 seconds"), 20096)
        self.assertEqual(
            timeparse.timeparse("-5 hours, 34 minutes, 56 seconds"), -20096
        )
    ...
    def test_timeparse_16(self):
        ...
        self.assertEqual(
            timeparse.timeparse("2 days, 5 hours, 34 minutes, 56 seconds"), 192896
        )
        self.assertEqual(
            timeparse.timeparse("+2 days, 5 hours, 34 minutes, 56 seconds"), 192896
        )
