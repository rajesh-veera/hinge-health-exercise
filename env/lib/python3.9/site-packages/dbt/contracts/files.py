...
class SchemaSourceFile(BaseSourceFile):
    ...
    def add_metrics_from_measures(
        self, semantic_model_name: str, metric_unique_id: str
    ):
                    ...
                    if "measures" in sem_model:
                        for measure in sem_model["measures"]:
                            if measure["name"] == metric_name:
                                self.add_metrics_from_measures(
                                    sem_model["name"], metric_unique_id
                                )
                                break
    ...
    def get_unrendered_config(
        self, yaml_key, name, version=None
    ...
    def add_unrendered_database(
        self, yaml_key: str, name: str, unrendered_database: str
    ) -> None:
    ...
    def add_unrendered_schema(
        self, yaml_key: str, name: str, unrendered_schema: str
    ) -> None:
