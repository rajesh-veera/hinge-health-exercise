...
class GitPackage(Package):
    ...
    warn_unpinned: Optional[bool] = field(
        default=None, metadata={"alias": "warn-unpinned"}
    )
...
PackageSpec = Union[
    LocalPackage, TarballPackage, GitPackage, RegistryPackage, PrivatePackage
]
...
class Project(dbtClassMixin):
    ...
    # Annotated is used by mashumaro for jsonschema generation
    version: Optional[
        Union[Annotated[SemverString, Pattern(sem_ver_pattern)], float]
    ] = None
    ...
    query_comment: Optional[Union[QueryComment, NoValue, str]] = field(
