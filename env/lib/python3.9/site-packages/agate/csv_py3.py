...
class Reader:
    ...
    def __init__(
        self, f, field_size_limit=None, line_numbers=False, header=True, **kwargs
    ):
...
class Sniffer:
    ...
    def sniff(self, sample):
        ...
        try:
            ...
            warnings.warn(
                "Error sniffing CSV dialect: %s" % e, RuntimeWarning, stacklevel=2
            )
            dialect = None
