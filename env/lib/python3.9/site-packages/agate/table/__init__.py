...
class Table:
    ...
    def __init__(
        self, rows, column_names=None, column_types=None, row_names=None, _is_fork=False
    ):
            ...
            for i, row in enumerate(rows):
                ...
                for j, d in enumerate(row):
                    try:
                        ...
                        raise CastError(
                            str(e)
                            + f" Error at row {i} column {self._column_names[j]}."
                        )
    ...
    def _fork(self, rows, column_names=None, column_types=None, row_names=None):
        ...
        return Table(
            rows, column_names, column_types, row_names=row_names, _is_fork=True
        )
