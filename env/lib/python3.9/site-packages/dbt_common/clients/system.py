    ...
    for relative_path_to_search in relative_paths_to_search:
        ...
        for current_path, subdirectories, local_files in walk_results:
            ...
            for local_file in local_files:
                ...
                relative_path_to_root = os.path.join(
                    relative_path_to_search, relative_path
                )
...
def _handle_windows_error(exc: OSError, cwd: str, cmd: List[str]) -> NoReturn:
    ...
    ] = dbt_common.exceptions.base.CommandError
    if exc.errno == errno.ENOENT:
        message = (
...
def run_cmd(
    ...
    if proc.returncode != 0:
        ...
        raise dbt_common.exceptions.CommandResultError(
            cwd, cmd, proc.returncode, out, err
        )
