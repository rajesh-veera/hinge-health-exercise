...
class ColumnTypeBuilder(Dict[str, NullableAgateType]):
    ...
    def __setitem__(self, key, value):
        ...
        elif isinstance(value, Integer) and isinstance(
            existing_type, agate.data_types.Number
        ):
            # use the existing value
            return
        elif isinstance(existing_type, Integer) and isinstance(
            value, agate.data_types.Number
        ):
            # overwrite
            super().__setitem__(key, value)
