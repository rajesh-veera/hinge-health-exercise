...
def json_decode(
    ...
    return JSONDecoder(shape_type, pre_decoder_func=pre_decoder_func).decode(data)
...
def json_encode(
    ...
    return JSONEncoder(shape_type, post_encoder_func=post_encoder_func).encode(obj)
