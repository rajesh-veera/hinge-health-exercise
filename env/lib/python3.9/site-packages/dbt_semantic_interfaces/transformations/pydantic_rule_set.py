...
class PydanticSemanticManifestTransformRuleSet(
    ...
    def _implements_protocol(
        self,
    ) -> SemanticManifestTransformRuleSet[PydanticSemanticManifest]:  # noqa: D
        return self

    @property
    def primary_rules(
        self,
    ) -> Sequence[SemanticManifestTransformRule[PydanticSemanticManifest]]:  # noqa:
    ...
    def all_rules(
        ...
        Sequence[SemanticManifestTransformRule[PydanticSemanticManifest]]
    ]:  # noqa: D
