...
class SemanticManifestTransformer(Protocol[SemanticManifestT]):
    ...
    def transform(
        ...
        ordered_rule_sequences: Optional[
            Sequence[Sequence[SemanticManifestTransformRule]]
        ] = None,
    ) -> SemanticManifestT:
...
class PydanticSemanticManifestTransformer(
    ProtocolHint[SemanticManifestTransformer[PydanticSemanticManifest]]
):
    ...
    def _implements_protocol(
        self,
    ) -> SemanticManifestTransformer[PydanticSemanticManifest]:  # noqa: D
        return self
    ...
    def transform(  # noqa: D
        ...
        if ordered_rule_sequences is None:
            ordered_rule_sequences = (
                PydanticSemanticManifestTransformRuleSet().all_rules
            )
