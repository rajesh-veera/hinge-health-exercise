...
class DimensionConsistencyRule(
    ...
    * Dimensions with the same name should be either all partitions or not.
    ...
    @staticmethod
    @validate_safely(
        whats_being_done="running model validation ensuring dimension consistency"
    )
    ...
    def _validate_dimension(
        ...
        if dimension.type == DimensionType.TIME:
            if (
                dimension.reference not in time_dims_to_granularity
