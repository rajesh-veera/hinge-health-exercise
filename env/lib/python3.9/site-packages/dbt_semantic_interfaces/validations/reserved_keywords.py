...
class ReservedKeywordsRule(
    ...
    @staticmethod
    @validate_safely(
        whats_being_done="checking that semantic model sub element names aren't reserved sql keywords"
    )
    def _validate_semantic_model_sub_elements(
    ...
    @classmethod
    @validate_safely(
        whats_being_done="checking that semantic_model node_relations are not sql reserved keywords"
    )
    def _validate_semantic_models(
        cls, semantic_manifest: SemanticManifest
    ) -> List[ValidationIssue]:
        ...
        for semantic_model in semantic_manifest.semantic_models:
            set_sql_table_path_parts = set(
                [
                    part.upper()
                    for part in semantic_model.node_relation.relation_name.split(".")
                ]
            )
            ...
            issues += cls._validate_semantic_model_sub_elements(
