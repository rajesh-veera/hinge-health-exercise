...
class PydanticTimeSpinePrimaryColumn(
    HashableBaseModel, ProtocolHint[TimeSpinePrimaryColumn]
):  # noqa: D101
    @override
...
class PydanticTimeSpine(HashableBaseModel, ProtocolHint[TimeSpine]):  # noqa: D101
    ...
    custom_granularities: Sequence[PydanticTimeSpineCustomGranularityColumn] = Field(
