...
conversion_type_params_schema = {
    ...
    "properties": {
        ...
        "constant_properties": {
            "type": "array",
            "items": {"$ref": "constant_property_input_schema"},
        },
    },
    "additionalProperties": False,
...
dimension_schema = {
    ...
    "anyOf": [
        {"not": {"$ref": "#/definitions/is-time-dimension"}},
...
resources: List[Tuple[str, Resource]] = [
    (str(k), DRAFT7.create_resource(v)) for k, v in schema_store.items()
]
...
project_configuration_validator = SchemaValidator(
    project_configuration_schema, registry=registry
)
