...
class ParsingContext:
    ...
    def __init__(
        self, start_line: int, end_line: int, filename: str, content_node: yaml.Node
    ) -> None:
    ...
    def load_all_with_context(name: str, contents: str) -> Iterator:
        ...
        with StringIO(initial_value=contents) as stream:
            ...
            for document in yaml.load_all(
                stream=stream, Loader=SafeLineLoaderWithAddedContext
            ):
                yield document
...
class SafeLineLoaderWithAddedContext(yaml.SafeLoader):
    ...
    def construct_mapping(self, node: yaml.MappingNode, deep: bool = False) -> Dict:
        ...
        """
        mapping = super(SafeLineLoaderWithAddedContext, self).construct_mapping(
            node, deep=deep
        )
