...
def parse_yaml_files_to_validation_ready_semantic_manifest(
    ...
    try:
        ...
        build_issues = SemanticManifestValidationResults.merge(
            [build_issues, transformation_issue_results]
        )
...
def parse_yaml_files_to_semantic_manifest(
    ...
    project_configuration_class: Type[
        PydanticProjectConfiguration
    ] = PydanticProjectConfiguration,
        ...
        for config_document in YamlConfigLoader.load_all_with_context(
            ...
            if VERSION_KEY in config_document:
                ...
                if major_version != 0:
                    issues.append(
                        ValidationError(
                            context=FileContext(
                                file_name=ctx.filename, line_number=ctx.start_line
                            ),
            ...
            try:
                if document_type == METRIC_TYPE:
                    ...
                    project_configuration_validator.validate(
                        config_document[document_type]
                    )
