...
def assert_includes_all_serializable_dataclass_types(
    ...
    excluded_classes: Iterable[Type[SerializableDataclass]],
) -> None:
    ...
    missing_type_names = sorted(
        instance_type.__name__ for instance_type in missing_instance_types
    )
    assert (
...
def assert_serializable(instances: Sequence[SerializableDataclass]) -> None:
    ...
    for instance in instances:
        try:
            ...
            deserialized_instance = deserializer.pydantic_deserialize(
                type(instance), serialized_output
            )
