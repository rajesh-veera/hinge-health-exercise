#!/Users/rajesh/hinge-health-exercise/env/bin/python
# -*- coding: utf-8 -*-
# -*- coding: utf-8 -*-
...
imap = itertools.imap if hasattr(itertools, "imap") else map
import itertools

ifilter = itertools.ifilter if hasattr(itertools, "ifilter") else filter
...
class Enum(object):
    ...
    def __str__(self):
        if self.params is None:
            ...
            return self.tag + "(" + (", ".join(unicode(v) for v in self.params)) + ")"
...
class Alignment(object):
        ...
        result = (
            (
                ...
                + HxOverrides.stringOrNull(
                    (("null" if ((self.map_a2b is None)) else self.map_a2b.toString()))
                )
            )
            + " // "
        ) + HxOverrides.stringOrNull(
            (("null" if ((self.map_b2a is None)) else self.map_b2a.toString()))
        )
        if self.reference is not None:
            result = ("null" if result is None else result) + (
                ((" (" + Std.string(self.reference)) + ")")
            )
        return result
    ...
    def toOrder3(self):
        ...
        def _hx_local_0(a, b):
            return (order[a] if a >= 0 and a < len(order) else None).r - (
                order[b] if b >= 0 and b < len(order) else None
            ).r
        ...
        def _hx_local_1(a, b):
            if a == b:
                return 0
            if ((order[a] if a >= 0 and a < len(order) else None).l >= 0) and (
                ((order[b] if b >= 0 and b < len(order) else None).l >= 0)
            ):
                return (order[a] if a >= 0 and a < len(order) else None).l - (
                    order[b] if b >= 0 and b < len(order) else None
                ).l
        ...
        if self.reference is not None:
            ...
            def _hx_local_2(a, b):
                if a == b:
                    return 0
                o1 = (order[a] if a >= 0 and a < len(order) else None).r - (
                    order[b] if b >= 0 and b < len(order) else None
                ).r
                if ((order[a] if a >= 0 and a < len(order) else None).p >= 0) and (
                    ((order[b] if b >= 0 and b < len(order) else None).p >= 0)
                ):
                    o2 = (order[a] if a >= 0 and a < len(order) else None).p - (
                        order[b] if b >= 0 and b < len(order) else None
                    ).p
                    if (o1 * o2) < 0:
                        return o1
                    o3 = (order[a] if a >= 0 and a < len(order) else None).l - (
                        order[b] if b >= 0 and b < len(order) else None
                    ).l
                    return o3
                return o1
            ...
            def _hx_local_3(a, b):
                ...
                if ((order[a] if a >= 0 and a < len(order) else None).l >= 0) and (
                    ...
                    o1 = (order[a] if a >= 0 and a < len(order) else None).l - (
                        order[b] if b >= 0 and b < len(order) else None
                    ).l
                    if ((order[a] if a >= 0 and a < len(order) else None).p >= 0) and (
                        ((order[b] if b >= 0 and b < len(order) else None).p >= 0)
        ...
        while _g < _g1:
            ...
            if (at_r < len(remotes)) and ((at_l < len(locals))):
                ur = python_internal_ArrayImpl._get(
                    order,
                    (remotes[at_r] if at_r >= 0 and at_r < len(remotes) else None),
                )
                ul = python_internal_ArrayImpl._get(
                    order, (locals[at_l] if at_l >= 0 and at_l < len(locals) else None)
                )
                ...
                continue
            if at_r < len(remotes):
                ur1 = python_internal_ArrayImpl._get(
                    order,
                    (remotes[at_r] if at_r >= 0 and at_r < len(remotes) else None),
                )
                ...
                continue
            if at_l < len(locals):
                ul1 = python_internal_ArrayImpl._get(
                    order, (locals[at_l] if at_l >= 0 and at_l < len(locals) else None)
                )
...
class CellInfo(object):
    ...
    def toString(self):
        ...
        if not self.conflicted:
            return (
                HxOverrides.stringOrNull(self.lvalue) + "::"
            ) + HxOverrides.stringOrNull(self.rvalue)
        return (
            (
                (HxOverrides.stringOrNull(self.pvalue) + "||")
                + HxOverrides.stringOrNull(self.lvalue)
            )
            + "::"
        ) + HxOverrides.stringOrNull(self.rvalue)
...
class CompareFlags(object):
    ...
    def getIgnoredColumns(self):
        ...
        while _g < _g1:
            ...
            ignore.h[
                (
                    self.columns_to_ignore[i]
                    if i >= 0 and i < len(self.columns_to_ignore)
                    else None
                )
            ] = True
        return ignore
        ...
        while _g < len(_g1):
            ...
            if ((unit.l >= 0) and ((unit.r >= 0))) and ((unit.p != -1)):
                if ignore is not None:
                    if ((unit.l >= 0) and ((ra_header >= 0))) and (
                        (ra_header < a.get_height())
                    ):
                        name = av.toString(a.getCell(unit.l, ra_header))
                        if name in ignore.h:
                            continue
                    if ((unit.r >= 0) and ((rb_header >= 0))) and (
                        (rb_header < b.get_height())
                    ):
        ...
        if ids is not None:
            ...
            if len(common_units) > N:
                ...
                while _g < _g1:
                    ...
                    ca = (
                        common_units[i] if i >= 0 and i < len(common_units) else None
                    ).l
                    cb = (
                        common_units[i] if i >= 0 and i < len(common_units) else None
                    ).r
            ...
            while _g < _g1:
                ...
                while kk > 0:
                    if HxOverrides.mod(kk, 2) == 1:
                        active_columns.append(
                            (columns[at] if at >= 0 and at < len(columns) else None)
                        )
                    kk = kk >> 1
                    at = at + 1
                ...
                while _g2 < _g3:
                    ...
                    col = (
                        active_columns[k1]
                        if k1 >= 0 and k1 < len(active_columns)
                        else None
                    )
                    unit = (
                        common_units[col]
                        if col >= 0 and col < len(common_units)
                        else None
                    )
...
class Coopy(object):
    ...
    def checkFormat(self, name):
        ...
        if name is not None:
            ...
            if startIndex is None:
                ...
                startLeft = (
                    max(0, ((startIndex + 1) - len("."))) if ((i == -1)) else (i + 1)
                )
            ...
            if pt >= 0:
                ...
                if _hx_local_0 == 4:
                    ...
                    if ext1 == "csv":
                        ...
                        self.format_preference = "csv"
                        self.delim_preference = "".join(imap(unichr, [128169]))
                    elif ext1 == "ssv":
                        self.format_preference = "csv"
                        self.delim_preference = ";"
                        self.format_preference = "csv"
                    ...
                    ext = ""
        self.nested_output = (self.format_preference == "json") or (
            (self.format_preference == "ndjson")
        )
    ...
    def encodeTable(self, name, t, render=None):
        ...
        if render is None:
            if self.format_preference == "csv":
                ...
                txt = Ndjson(t).render()
            elif (self.format_preference == "html") or (
                (self.format_preference == "www")
            ):
    ...
    def saveTables(self, name, os, use_color, is_diff):
        ...
        if (len(order) == 0) or os.hasInsDel():
            txt = ("null" if txt is None else txt) + HxOverrides.stringOrNull(
                self.encodeTable(name, os.one(), render)
            )
            need_blank = True
        if len(order) > 1:
            _g = 1
                ...
                if t is not None:
                    ...
                    txt = ("null" if txt is None else txt) + HxOverrides.stringOrNull(
                        (
                            (
                                HxOverrides.stringOrNull(
                                    (order[i] if i >= 0 and i < len(order) else None)
                                )
                                + "\n"
                            )
                        )
                    ...
                    txt = ("null" if txt is None else txt) + HxOverrides.stringOrNull(
                        self.encodeTable(
                            name,
                            os.get((order[i] if i >= 0 and i < len(order) else None)),
                            render,
                        )
                    )
        return self.saveText(name, txt)
    ...
    def saveText(self, name, txt):
        if name is None:
            ...
            _hx_local_0.cache_txt = ("null" if _hx_local_1 is None else _hx_local_1) + (
                "null" if txt is None else txt
            )
            ...
            while _g2 < _g3:
                ...
                if not has_hash:
                    ...
                    while _g6 < _g7:
                        ...
                        val1 = Reflect.field(
                            row,
                            (columns[j1] if j1 >= 0 and j1 < len(columns) else None),
                        )
    ...
    def useColor(self, flags, output):
        ...
        if flags.terminal_format is None:
            if (((output is None) or ((output == "-")))) and (
                (
                    ((self.output_format == "copy") or ((self.output_format == "csv")))
                    or ((self.output_format == "psv"))
                )
            ):
    ...
    def loadTable(self, name, role):
        ...
        if (ext == "json") or ((ext == "")):
            try:
                json = python_lib_Json.loads(
                    txt,
                    **python__KwArgs_KwArgs_Impl_.fromT(
                        _hx_AnonObject({"object_hook": python_Lib.dictToAnon})
                    )
                )
                self.format_preference = "json"
            ...
            while _g < len(args):
                ...
                spaced = (
                    (
                        arg.find(" ")
                        if ((startIndex is None))
                        else HxString.indexOfImpl(arg, " ", startIndex)
                    )
                ) >= 0
                if spaced:
                    io.writeStdout('"')
                            ...
                            (
                                (
                                    (
                                        (
                                            "- Can run "
                                            + ("null" if daff is None else daff)
                                        )
                                        + ' as "'
                                    )
                                    + ("null" if daff is None else daff)
            ...
            if not (key in self.status.h):
                r = self.command(
                    ...
                    [
                        ...
                        "--get",
                        (
                            ("diff.daff-" + ("null" if format is None else format))
                            + ".command"
                        ),
                    ],
                )
            ...
            if not (key in self.status.h):
                r = self.command(
                    ...
                    [
                        ...
                        (HxOverrides.stringOrNull(self.daff_cmd) + " diff --git"),
                    ],
                )
                if r == 999:
                    return r
                if have_diff_driver:
                    io.writeStdout(
                        (
                            (
                                "- Cleared existing daff diff driver for "
                                + ("null" if format is None else format)
                            )
                            + "\n"
                        )
                    )
            ...
            if not (key in self.status.h):
                r = self.command(
                    ...
                    [
                        ...
                        "--get",
                        (
                            ("merge.daff-" + ("null" if format is None else format))
                            + ".driver"
                        ),
                    ],
                )
            ...
            if not (key in self.status.h):
                r = self.command(
                    ...
                    [
                        ...
                        (
                            HxOverrides.stringOrNull(self.daff_cmd)
                            + " merge --output %A %O %A %B"
                        ),
                    ],
                )
                if r == 999:
                ...
                if have_merge_driver:
                    io.writeStdout(
                        (
                            (
                                "- Cleared existing daff merge driver for "
                                + ("null" if format is None else format)
                            )
                            + "\n"
                        )
        ...
        while _g < len(formats):
            ...
            if (
                (
                    txt.find(_hx_str)
                    if ((startIndex is None))
                    else HxString.indexOfImpl(txt, _hx_str, startIndex)
                )
            ) >= 0:
                io.writeStderr(
                    (
                        (
                            "- Your .gitattributes file already mentions *."
                            + ("null" if format is None else format)
                        )
                        + "\n"
                    )
                ...
                post = ("null" if post is None else post) + HxOverrides.stringOrNull(
                    (
                        (
                            (
                                (
                ...
                if (txt != "") and (not need_update):
                    txt = ("null" if txt is None else txt) + "\n"
                txt = ("null" if txt is None else txt) + (
                    "null" if post is None else post
                )
                need_update = True
        if need_update:
        ...
        while more:
            ...
            while _g < _g1:
                ...
                if tag == "--output":
                    ...
                    self.flags.acts.h[
                        python_internal_ArrayImpl._get(args, (i + 1))
                    ] = True
                    pos8 = i
                    if pos8 < 0:
                        pos8 = len(args) + pos8
                    ...
                    if python_lib_Math.isnan(self.flags.ignore_epsilon):
                        io.writeStderr(
                            "Epsilon for numeric comparison must be numeric\n"
                        )
                        return 1
                    pos26 = i
                    if pos26 < 0:
                    ...
                    more = True
                    self.flags.padding_strategy = python_internal_ArrayImpl._get(
                        args, (i + 1)
                    )
                    pos27 = i
                    if pos27 < 0:
                    ...
                    if ending == "crlf":
                        ...
                        io.writeStderr(
                            (
                                (
                                    "Expected line ending of either 'crlf' or 'lf' but got "
                                    + ("null" if ending is None else ending)
                                )
                                + "\n"
                            )
                        )
        ...
        try:
            if len(args) < 2:
                ...
                if len(args) < 1:
                    ...
                    io.writeStderr(
                        "     -d EPS / --ignore-epsilon EPS: ignore small floating point differences\n"
                    )
                    io.writeStderr("\n")
                    io.writeStderr(
            ...
            offset = 1
            if not Lambda.has(
                ["diff", "patch", "merge", "trim", "render", "git", "version", "copy"],
                cmd,
            ):
                startIndex = None
                if (
                    (
                        cmd.find("--")
                        if ((startIndex is None))
                        else HxString.indexOfImpl(cmd, "--", startIndex)
                    )
                ) == 0:
                    cmd = "diff"
                    offset = 0
            ...
            if git:
                ...
                if (ct != 7) and ((ct != 9)):
                    io.writeStderr(
                        (
                            (
                                "Expected 7 or 9 parameters from git, but got "
                                + Std.string(ct)
                            )
                            + "\n"
                        )
                ...
                io.writeStdout(
                    (
                        (
                            "--- a/"
                            + ("null" if old_display_path is None else old_display_path)
                        )
                        + "\n"
                    )
                )
                io.writeStdout(
                    (
                        (
                            "+++ b/"
                            + ("null" if new_display_path is None else new_display_path)
                        )
                        + "\n"
                    )
                )
            ...
            if (len(args) - offset) >= 3:
                parent = self.loadTable(
                    (args[offset] if offset >= 0 and offset < len(args) else None),
                    "parent",
                )
                offset = offset + 1
            ...
            if (len(args) - offset) >= 2:
                if cmd != "copy":
                    b = self.loadTable(
                        python_internal_ArrayImpl._get(args, (1 + offset)), "remote"
                    )
                else:
            ...
            if inplace:
                if output is not None:
                    io.writeStderr(
                        "Please do not use --inplace when specifying an output.\n"
                    )
                output = aname
                return 1
            if output is None:
    ...
    def renderCell(self, v, d, force_quote=None):
            ...
            if len(_hx_str) > 0:
                ...
                if (("" if ((0 >= len(_hx_str))) else _hx_str[0])) != " ":
                    ...
                    tmp = (
                        (
                            ""
                            if (((index < 0) or ((index >= len(_hx_str)))))
                            else _hx_str[index]
                        )
                    ) == " "
                else:
        ...
        while _g < _g1:
            ...
            if (ch != "\r") and ((ch != "\n")):
                if len(line_buf) > 0:
                    result = ("null" if result is None else result) + (
                        "null" if line_buf is None else line_buf
                    )
                    line_buf = ""
                result = ("null" if result is None else result) + (
                    "null" if ch is None else ch
                )
            else:
                line_buf = ("null" if line_buf is None else line_buf) + (
                    "null" if ch is None else ch
                )
        if len(line_buf) > 0:
            result = ("null" if result is None else result) + (
                ...
                if yat > 0:
                    if (cell != "") and ((cell is not None)):
                        ...
                        while _g < _g1:
                            ...
                            context = (
                                "null" if context is None else context
                            ) + Std.string(tab.getCell(i, yat))
                        print(
                            unicode(
                                (
                                    (
                                        (
                                            (
                                                (
                                                    "Ignored overflowing row "
                                                    + Std.string(yat)
                                                )
                                                + " with cell '"
                                            )
                                            + ("null" if cell is None else cell)
                                        )
                                        + "' after: "
                                    )
                                    + ("null" if context is None else context)
        ...
        while _g < _g1:
            ...
            if self.has_structure:
                if not quoting:
                            ...
                            if ch2 != ch:
                                if (ch2 == 13) or ((ch2 == 10)):
                                    if self.discovered_eol is None:
                                        self.discovered_eol = HxOverrides.stringOrNull(
                                            "".join(imap(unichr, [ch]))
                                        ) + HxOverrides.stringOrNull(
                                            "".join(imap(unichr, [ch2]))
                                        )
                                    last_processed = last_processed + 1
                        if self.discovered_eol is None:
                            self.discovered_eol = "".join(imap(unichr, [ch]))
                        self.row_ended = True
                        break
                    if ch == 34:
                        if i == self.cursor:
                    ...
                    result = (
                        "null" if result is None else result
                    ) + HxOverrides.stringOrNull("".join(imap(unichr, [ch])))
                    continue
                if ch == quote:
                    quoting = False
                    continue
            result = ("null" if result is None else result) + HxOverrides.stringOrNull(
                "".join(imap(unichr, [ch]))
            )
...
class Date(object):
    ...
    def __init__(self, year, month, day, hour, _hx_min, sec):
        ...
        if day == 0:
            day = 1
        self.date = Date.makeLocal(
            python_lib_datetime_Datetime(year, (month + 1), day, hour, _hx_min, sec, 0)
        )
    ...
    def makeLocal(date):
        try:
            ...
            None
            tzinfo = (
                python_lib_datetime_Datetime.now(python_lib_datetime_Timezone.utc)
                .astimezone()
                .tzinfo
            )
            return date.replace(
                **python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({"tzinfo": tzinfo}))
            )
...
class DiffRender(object):
    ...
    def insertCell(self, txt, mode):
        ...
        self.insert(
            (
                (
                    HxOverrides.stringOrNull(self.td_open)
                    + ("null" if cell_decorate is None else cell_decorate)
                )
                + ">"
            )
        )
    ...
    def render(self, tab):
        ...
        while _g < _g1:
            ...
            if row_mode == "spec":
                change_row = row
            if (
                ((row_mode == "header") or ((row_mode == "spec")))
                or ((row_mode == "index"))
            ) or ((row_mode == "meta")):
            ...
            while _g2 < _g3:
                c = _g2
                _g2 = _g2 + 1
                DiffRender.examineCell(
                    c,
                    row,
                    view,
                    tab.getCell(c, row),
                    (
                        view.toString(tab.getCell(c, change_row))
                        if ((change_row >= 0))
                        else ""
                    ),
                    txt,
    ...
    def examineCell(x, y, view, raw, vcol, vrow, vcorner, cell, offset=None):
        ...
        if vcol is None:
            vcol = ""
        if (
            (len(vrow) >= 3) and (((("" if ((0 >= len(vrow))) else vrow[0])) == "@"))
        ) and (((("" if ((1 >= len(vrow))) else vrow[1])) != "@")):
        ...
        if (
            (
                vcol.find("+++")
                if ((startIndex is None))
                else HxString.indexOfImpl(vcol, "+++", startIndex)
            )
        ) >= 0:
        ...
        if vrow == "!":
            ...
            if (
                (
                    vrow.find("->")
                    if ((startIndex is None))
                    else HxString.indexOfImpl(vrow, "->", startIndex)
                )
            ) >= 0:
                if not removed_column:
                    tokens = vrow.split("!")
                    ...
                    if not nested:
                        ...
                        tmp = (
                            (
                                _hx_str.find(part)
                                if ((startIndex is None))
                                else HxString.indexOfImpl(_hx_str, part, startIndex)
                            )
                        ) >= 0
                    else:
                        tmp = True
                    if tmp:
                            ...
                            if nested:
                                ...
                                cell.conflicted = (
                                    (
                                        _hx_str.find(full)
                                        if ((startIndex is None))
                                        else HxString.indexOfImpl(
                                            _hx_str, full, startIndex
                                        )
                                    )
                                ) >= 0
                            if cell.conflicted:
                        ...
                        if nested:
                            ...
                            if cell.pretty_value == div:
                                ...
                                tokens = (
                                    list(_this) if ((div == "")) else _this.split(div)
                                )
                        ...
                        if len(tokens) >= 2:
                            python_internal_ArrayImpl._set(
                                pretty_tokens,
                                0,
                                DiffRender.markSpaces(
                                    (tokens[0] if 0 < len(tokens) else None),
                                    (tokens[1] if 1 < len(tokens) else None),
                                ),
                            )
                            python_internal_ArrayImpl._set(
                                pretty_tokens,
                        ...
                        if len(tokens) >= 3:
                            ...
                            python_internal_ArrayImpl._set(
                                ...
                                0,
                                DiffRender.markSpaces(
                                    ref, (tokens[2] if 2 < len(tokens) else None)
                                ),
                            )
                            python_internal_ArrayImpl._set(
                                pretty_tokens,
                                2,
                                DiffRender.markSpaces(
                                    (tokens[2] if 2 < len(tokens) else None), ref
                                ),
                            )
                        cell.pretty_separator = "".join(imap(unichr, [8594]))
                        cell.pretty_value = cell.pretty_separator.join(
                            [python_Boot.toString1(x1, "") for x1 in pretty_tokens]
                        )
                        ...
                        cell.lvalue = (
                            tokens[offset1]
                            if offset1 >= 0 and offset1 < len(tokens)
                            else None
                        )
                        cell.rvalue = python_internal_ArrayImpl._get(
                            tokens, (offset1 + 1)
                        )
                        if cell.conflicted:
    ...
    def markSpaces(sl, sr):
        ...
        while il < len(sl):
            ...
            if cl == cr:
                ...
                slo = ("null" if slo is None else slo) + HxOverrides.stringOrNull(
                    "".join(imap(unichr, [9251]))
                )
                il = il + 1
        return slo
...
class FlatCellBuilder(object):
    ...
    def update(self, local, remote):
        return self.view.toDatum(
            (
                (
                    HxOverrides.stringOrNull(
                        FlatCellBuilder.quoteForDiff(self.view, local)
                    )
                    + HxOverrides.stringOrNull(self.separator)
                )
                + HxOverrides.stringOrNull(
                    FlatCellBuilder.quoteForDiff(self.view, remote)
                )
            )
        )
    ...
    def conflict(self, parent, local, remote):
        return (
            (
                (
                    HxOverrides.stringOrNull(self.view.toString(parent))
                    + HxOverrides.stringOrNull(self.conflict_separator)
                )
                + HxOverrides.stringOrNull(self.view.toString(local))
            )
            + HxOverrides.stringOrNull(self.conflict_separator)
        ) + HxOverrides.stringOrNull(self.view.toString(remote))
...
class HighlightPatch(object):
    ...
    _hx_methods = [
        ...
        "sortMods",
        "processMods",
        "useMetaForColumnChanges",
        "useMetaForRowChanges",
        "computeOrdering",
        "permuteRows",
        "fillInNewColumns",
        "finishRows",
    ...
    def applyMetaRow(self, code):
        ...
        while _g < _g1:
            ...
            idx_patch = i
            idx_src = (
                self.patchInSourceCol.h.get(idx_patch, None)
            ...
            if self.cellInfo.updated:
                self.setMetaProp(
                    self.prev_meta, prev_name, prop_name, self.cellInfo.lvalue
                )
                self.setMetaProp(self.next_meta, name, prop_name, self.cellInfo.rvalue)
            else:
                self.setMetaProp(
                    self.prev_meta, prev_name, prop_name, self.cellInfo.value
                )
        ...
        if (r == 0) and ((self.rcOffset > 0)):
            ...
            if (
                (
                    code.find("@")
                    if ((startIndex is None))
                    else HxString.indexOfImpl(code, "@", startIndex)
                )
            ) == 0:
                self.flags.addWarning(
                    (
                        (
                            "cannot usefully apply diffs with metadata yet: '"
                            + ("null" if code is None else code)
                        )
                        + "'"
                    )
                )
    ...
    def applyAction(self, code):
        ...
        if mod.add:
            if (
                python_internal_ArrayImpl._get(self.actions, (self.currentRow - 1))
                != "+++"
            ):
                if (
                    python_internal_ArrayImpl._get(self.actions, (self.currentRow - 1))
    ...
    def getPreString(self, txt):
        ...
        if not self.rowInfo.updated:
            return txt
        DiffRender.examineCell(
            0, 0, self.view, txt, "", self.rowInfo.value, "", self.cellInfo
        )
    ...
    def computeOrdering(self, mods, permutation, permutationRev, dim):
        ...
        if ct > 0:
            ...
            while _g < _g1:
                ...
                python_internal_ArrayImpl._set(
                    permutation,
                    (permutationRev[i] if i >= 0 and i < len(permutationRev) else None),
                    i,
                )
    ...
    def finishRows(self):
        ...
        if len(self.rowPermutation) > 0:
            ...
            while _g < len(_g1):
                ...
                _g = _g + 1
                if mod.sourceRow >= 0:
                    mod.sourceRow = python_internal_ArrayImpl._get(
                        self.rowPermutation, mod.sourceRow
                    )
        if len(self.rowPermutation) > 0:
            self.source.insertOrDeleteRows(
                self.rowPermutation, len(self.rowPermutation)
            )
                ...
                if mod.add:
                    ...
                    while c.hasNext():
                        ...
                        if (offset is not None) and ((offset >= 0)):
                            self.source.setCell(
                                offset,
                                mod.destRow,
                                self.patch.getCell(c1, mod.patchRow),
                            )
                elif mod.update:
                    ...
                    while c2.hasNext():
                        ...
                        if (offset1 is not None) and ((offset1 >= 0)):
                            self.source.setCell(
                                self.patchInDestCol.h.get(c3, None), mod.destRow, d
                            )
    ...
    def finishColumns(self):
        ...
        while _g < _g1:
            ...
            if act == "---":
                ...
                mod1.sourceRow = -1
                if len(self.cmods) > 0:
                    mod1.sourceRow = python_internal_ArrayImpl._get(
                        self.cmods, (len(self.cmods) - 1)
                    ).sourceRow
                if mod1.sourceRow != -1:
        ...
        while _g < _g1:
            ...
            if (icode != "+++") and ((icode != "---")):
                at = (
                    self.cmods[i] if i >= 0 and i < len(self.cmods) else None
                ).sourceRow
            ...
            if (jcode != "+++") and ((jcode != "---")):
                rat = (
                    self.cmods[j] if j >= 0 and j < len(self.cmods) else None
                ).sourceRow
        ...
        if self.headerMove is not None:
            if len(self.colPermutation) > 0:
                ...
                while _g < len(_g1):
                    ...
                    if mod.sourceRow >= 0:
                        mod.sourceRow = python_internal_ArrayImpl._get(
                            self.colPermutation, mod.sourceRow
                        )
                if not self.useMetaForColumnChanges():
                    self.source.insertOrDeleteColumns(
                        self.colPermutation, len(self.colPermutation)
                    )
                                        ...
                                        (
                                            (
                                                (
                                                    ...
                                                    + Std.string(self.patchRow)
                                                )
                                                + " source "
                                            )
                                            + Std.string(self.sourcePrevRow)
                                        )
                                        + ":"
                                    )
                                    + Std.string(self.sourceRow)
                                )
                                + ":"
                            )
                            + Std.string(self.sourceNextRow)
                        )
                        + "+"
                    )
                    + Std.string(self.sourceRowOffset)
                )
                + " dest "
            )
            + Std.string(self.destRow)
        ) + ")"
...
class Index(object):
    ...
    def toKey(self, t, i):
        ...
        while _g < _g1:
            ...
            if (((txt is None) or ((txt == ""))) or ((txt == "null"))) or (
                (txt == "undefined")
            ):
                continue
    ...
    def toKeyByContent(self, row):
        ...
        while _g < _g1:
            k = _g
            _g = _g + 1
            txt = row.getRowString(
                (self.cols[k] if k >= 0 and k < len(self.cols) else None)
            )
            if self.ignore_whitespace:
                txt = StringTools.trim(txt)
            if self.ignore_case:
...
class IndexPair(object):
    ...
    def indexTables(self, a, b, hdr):
        ...
        self.quality = good / (
            (
                1.0
                if (python_lib_Math.isnan(1.0))
                else (b if (python_lib_Math.isnan(b)) else max(1.0, b))
            )
        )
...
class JsonTable(object):
    ...
    def getCell(self, x, y):
        ...
        return Reflect.field(
            python_internal_ArrayImpl._get(self.rows, (y - 1)),
            self.idx2col.h.get(x, None),
        )
...
class Merger(object):
    ...
    def shuffleColumns(self):
        ...
        fate = list()
        wfate = self.shuffleDimension(
            self.column_units,
            self.local.get_width(),
            fate,
            self.column_mix_local,
            self.column_mix_remote,
        )
    ...
    def shuffleRows(self):
        ...
        fate = list()
        hfate = self.shuffleDimension(
            self.units,
            self.local.get_height(),
            fate,
            self.row_mix_local,
            self.row_mix_remote,
        )
    ...
    def apply(self):
                        ...
                        if not view.equals(pcell, rcell):
                            ...
                            if view.equals(pcell, lcell):
                                ...
                                self.local.setCell(
                                    col.l,
                                    row.l,
                                    Merger.makeConflictedCell(
                                        view, pcell, lcell, rcell
                                    ),
                                )
                                _hx_local_2 = self
                                ...
                                _hx_local_3
                                self.addConflictInfo(
                                    row.l, col.l, view, pcell, lcell, rcell
                                )
        self.shuffleColumns()
        self.shuffleRows()
        ...
        while x.hasNext():
            ...
            while _g < len(_g1):
                ...
                if (unit.l >= 0) and ((unit.r >= 0)):
                    self.local.setCell(
                        x2,
                        self.row_mix_local.h.get(unit.l, None),
                        self.remote.getCell(x1, unit.r),
                    )
                elif (unit.p < 0) and ((unit.r >= 0)):
                    self.local.setCell(
                        x2,
                        self.row_mix_remote.h.get(unit.r, None),
                        self.remote.getCell(x1, unit.r),
                    )
        ...
        while y.hasNext():
            ...
            while _g < len(_g1):
                ...
                if (unit.l >= 0) and ((unit.r >= 0)):
                    self.local.setCell(
                        self.column_mix_local.h.get(unit.l, None),
                        y2,
                        self.remote.getCell(unit.r, y1),
                    )
    ...
    def addConflictInfo(self, row, col, view, pcell, lcell, rcell):
        ...
        x = ConflictInfo(
            row, col, view.toString(pcell), view.toString(lcell), view.toString(rcell)
        )
        _this.append(x)
        ...
        return view.toDatum(
            (
                (
                    (
                        (
                            ("((( " + HxOverrides.stringOrNull(view.toString(pcell)))
                            + " ))) "
                        )
                        + HxOverrides.stringOrNull(view.toString(lcell))
                    )
                    + " /// "
                )
                + HxOverrides.stringOrNull(view.toString(rcell))
            )
        )
                ...
                if to_left_src != to_left_dest:
                    ...
                    while _g < _g1:
                        ...
                        moved.append(
                            (
                                src[blki_src_loc]
                                if blki_src_loc >= 0 and blki_src_loc < len(src)
                                else None
                            )
                        )
...
class Ordering(object):
    ...
    def toString(self):
        ...
        while _g < _g1:
            ...
            if i > 0:
                txt = ("null" if txt is None else txt) + ", "
            txt = ("null" if txt is None else txt) + Std.string(
                (self.order[i] if i >= 0 and i < len(self.order) else None)
            )
        return txt
...
class RowChange(object):
    ...
    def showMap(self, m):
        ...
        while k.hasNext():
            ...
            v = m.h.get(k1, None)
            txt = ("null" if txt is None else txt) + HxOverrides.stringOrNull(
                (((("null" if k1 is None else k1) + "=") + Std.string(v)))
            )
    ...
    def toString(self):
        return (
            (
                (HxOverrides.stringOrNull(self.action) + " ")
                + HxOverrides.stringOrNull(self.showMap(self.cond))
            )
            + " : "
        ) + HxOverrides.stringOrNull(self.showMap(self.val))
            ...
            while _g2 < _g3:
                ...
                if (props[i] if i >= 0 and i < len(props) else None) in vals.h:
                    mt.setCell(
                        ...
                        (i + 1),
                        vals.h.get(
                            (props[i] if i >= 0 and i < len(props) else None), None
                        ),
                    )
        _g = 0
        _g1 = len(props)
        ...
        if meta is not None:
            ...
            if stream is not None:
                ...
                while _g < _g1:
                    ...
                    x = ("null" if x is None else x) + HxOverrides.stringOrNull(
                        (cols[i] if i >= 0 and i < len(cols) else None)
                    )
                x = ("null" if x is None else x) + "\n"
                row = stream.fetchRow()
                while row is not None:
                    ...
                    while _g < _g1:
                        ...
                        if i > 0:
                            x = ("null" if x is None else x) + ","
                        x = ("null" if x is None else x) + Std.string(
                            row.h.get(
                                (cols[i] if i >= 0 and i < len(cols) else None), None
                            )
                        )
                    x = ("null" if x is None else x) + "\n"
                    row = stream.fetchRow()
...
class SqlColumn(object):
    ...
    def toString(self):
        ...
        ) + HxOverrides.stringOrNull(self.name)
...
class SqlCompare(object):
    ...
    def __init__(self, db, local, remote, alt, align=None, flags=None):
        ...
        if (local is not None) and ((remote is not None)):
            if self.remote.getDatabase().getNameForAttachment() is not None:
                if (
                    self.remote.getDatabase().getNameForAttachment()
                    != self.local.getDatabase().getNameForAttachment()
                ):
                    local.getDatabase().getHelper().attach(
                        db, "__peer__", self.remote.getDatabase().getNameForAttachment()
                    )
                    self.peered = True
        if (self.alt is not None) and ((local is not None)):
            if self.alt.getDatabase().getNameForAttachment() is not None:
                if (
                    self.alt.getDatabase().getNameForAttachment()
                    != self.local.getDatabase().getNameForAttachment()
                ):
                    local.getDatabase().getHelper().attach(
                        db, "__alt__", self.alt.getDatabase().getNameForAttachment()
                    )
    ...
    def equalArray(self, a1, a2):
        ...
        while _g < _g1:
            i = _g
            _g = _g + 1
            if (a1[i] if i >= 0 and i < len(a1) else None) != (
                a2[i] if i >= 0 and i < len(a2) else None
            ):
                return False
        return True
    ...
    def validateSchema(self):
        ...
        if pk_missing:
            raise haxe_Exception.thrown(
                "sql diff not possible when primary key not available"
            )
        pk_change = False
        ...
        if pk_change:
            raise haxe_Exception.thrown(
                (
                    "sql diff not possible when primary key changes: "
                    + Std.string([key_cols1, key_cols2, key_cols3])
                )
            )
        return True
    ...
    def apply(self):
        ...
        while _g < _g1:
            ...
            _g = _g + 1
            present_primary.h[
                (key_cols[i] if i >= 0 and i < len(key_cols) else None)
            ] = i
        _g = 0
        _g1 = len(all_cols1)
        while _g < _g1:
        ...
        if self.alt is not None:
            self.scanColumns(
                all_cols1, all_cols3, key_cols, present1, present3, self.align.reference
            )
        ...
        while _g < _g1:
            ...
            sql_key_cols = (
                "null" if sql_key_cols is None else sql_key_cols
            ) + HxOverrides.stringOrNull(
                common.getQuotedColumnName(
                    (key_cols[i] if i >= 0 and i < len(key_cols) else None)
                )
            )
        sql_all_cols = ""
        ...
        while _g < _g1:
            ...
            sql_all_cols = (
                "null" if sql_all_cols is None else sql_all_cols
            ) + HxOverrides.stringOrNull(
                common.getQuotedColumnName(
                    (
                        all_common_cols[i]
                        if i >= 0 and i < len(all_common_cols)
                        else None
                    )
                )
            )
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_all_cols1 = (
                    "null" if sql_all_cols1 is None else sql_all_cols1
                ) + ","
            sql_all_cols1 = (
                "null" if sql_all_cols1 is None else sql_all_cols1
            ) + HxOverrides.stringOrNull(
                (
                    (
                        (("null" if sql_table1 is None else sql_table1) + ".")
                        + HxOverrides.stringOrNull(
                            self.local.getQuotedColumnName(
                                (
                                    all_cols1[i]
                                    if i >= 0 and i < len(all_cols1)
                                    else None
                                )
                            )
                        )
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_all_cols2 = (
                    "null" if sql_all_cols2 is None else sql_all_cols2
                ) + ","
            sql_all_cols2 = (
                "null" if sql_all_cols2 is None else sql_all_cols2
            ) + HxOverrides.stringOrNull(
                (
                    (
                        (("null" if sql_table2 is None else sql_table2) + ".")
                        + HxOverrides.stringOrNull(
                            self.remote.getQuotedColumnName(
                                (
                                    all_cols2[i]
                                    if i >= 0 and i < len(all_cols2)
                                    else None
                                )
                            )
                        )
        ...
        if self.alt is not None:
            ...
            while _g < _g1:
                ...
                if i > 0:
                    sql_all_cols3 = (
                        "null" if sql_all_cols3 is None else sql_all_cols3
                    ) + ","
                sql_all_cols3 = (
                    "null" if sql_all_cols3 is None else sql_all_cols3
                ) + HxOverrides.stringOrNull(
                    (
                        (
                            (("null" if sql_table3 is None else sql_table3) + ".")
                            + HxOverrides.stringOrNull(
                                self.alt.getQuotedColumnName(
                                    (
                                        all_cols3[i]
                                        if i >= 0 and i < len(all_cols3)
                                        else None
                                    )
                                )
                            )
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_key_null = (
                    "null" if sql_key_null is None else sql_key_null
                ) + " AND "
            n = common.getQuotedColumnName(
                (key_cols[i] if i >= 0 and i < len(key_cols) else None)
            )
            sql_key_null = (
                "null" if sql_key_null is None else sql_key_null
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_key_null2 = (
                    "null" if sql_key_null2 is None else sql_key_null2
                ) + " AND "
            n = common.getQuotedColumnName(
                (key_cols[i] if i >= 0 and i < len(key_cols) else None)
            )
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_key_match2 = (
                    "null" if sql_key_match2 is None else sql_key_match2
                ) + " AND "
            n = common.getQuotedColumnName(
                (key_cols[i] if i >= 0 and i < len(key_cols) else None)
            )
        ...
        if self.alt is not None:
            ...
            while _g < _g1:
                ...
                if i > 0:
                    sql_key_match3 = (
                        "null" if sql_key_match3 is None else sql_key_match3
                    ) + " AND "
                n = common.getQuotedColumnName(
                    (key_cols[i] if i >= 0 and i < len(key_cols) else None)
                )
        ...
        while _g < _g1:
            ...
            if i > 0:
                sql_data_mismatch = (
                    "null" if sql_data_mismatch is None else sql_data_mismatch
                ) + " OR "
            n = common.getQuotedColumnName(
                (data_common_cols[i] if i >= 0 and i < len(data_common_cols) else None)
            )
            sql_data_mismatch = (
                "null" if sql_data_mismatch is None else sql_data_mismatch
            ) + HxOverrides.stringOrNull(
        ...
        if self.alt is not None:
            ...
            while _g < _g1:
                ...
                n = common.getQuotedColumnName(
                    (
                        data_common_cols[i]
                        if i >= 0 and i < len(data_common_cols)
                        else None
                    )
                )
                sql_data_mismatch = (
        ...
        while _g < _g1:
            ...
            n = common.getQuotedColumnName(
                (all_cols1[i] if i >= 0 and i < len(all_cols1) else None)
            )
            sql_dbl_cols = (
                "null" if sql_dbl_cols is None else sql_dbl_cols
            ) + HxOverrides.stringOrNull(
                (
                    (
                        (
        ...
        while _g < _g1:
            ...
            n = common.getQuotedColumnName(
                (all_cols2[i] if i >= 0 and i < len(all_cols2) else None)
            )
            sql_dbl_cols = (
                "null" if sql_dbl_cols is None else sql_dbl_cols
            ) + HxOverrides.stringOrNull(
        ...
        if self.alt is not None:
            ...
            while _g < _g1:
                ...
                n = common.getQuotedColumnName(
                    (all_cols3[i] if i >= 0 and i < len(all_cols3) else None)
                )
                sql_dbl_cols = (
                    "null" if sql_dbl_cols is None else sql_dbl_cols
                ) + HxOverrides.stringOrNull(
        ...
        if rowid_name is not None:
            rowid = rowid_name
            if self.local is not None:
                rowid1 = (("null" if sql_table1 is None else sql_table1) + ".") + (
                    "null" if rowid_name is None else rowid_name
                )
            if self.remote is not None:
                rowid2 = (("null" if sql_table2 is None else sql_table2) + ".") + (
                    "null" if rowid_name is None else rowid_name
                )
            if self.alt is not None:
                rowid3 = (("null" if sql_table3 is None else sql_table3) + ".") + (
                    "null" if rowid_name is None else rowid_name
                )
        self.at0 = 1
        self.at1 = 1
        ...
        if self.remote is not None:
            sql_inserts = (
                (
                    (
                        (
                            "SELECT DISTINCT 0 AS __coopy_code, NULL, "
                            + ("null" if rowid2 is None else rowid2)
                        )
                        + " AS rowid, NULL, "
                    )
                    + ("null" if sql_all_cols2 is None else sql_all_cols2)
            ...
            if self.local is not None:
                sql_inserts = (
                    "null" if sql_inserts is None else sql_inserts
                ) + HxOverrides.stringOrNull(
                    ((" LEFT JOIN " + ("null" if sql_table1 is None else sql_table1)))
                )
                sql_inserts = (
                    "null" if sql_inserts is None else sql_inserts
                ) + HxOverrides.stringOrNull(
                    (
                        (
                            ...
                            + HxOverrides.stringOrNull(self.where(sql_key_null))
                        )
                    )
                )
        ...
        if self.alt is not None:
            sql_inserts = (
                (
                    (
                        (
                            "SELECT DISTINCT 0 AS __coopy_code, NULL, NULL, "
                            + ("null" if rowid3 is None else rowid3)
                        )
                        + " AS rowid, "
                    )
                    + ("null" if sql_all_cols3 is None else sql_all_cols3)
        ...
        if (self.local is not None) and ((self.remote is not None)):
            sql_updates = (
                (
                    (
                        "SELECT DISTINCT 2 AS __coopy_code, "
                        + ("null" if rowid1 is None else rowid1)
                    )
                    + " AS __coopy_rowid0, "
                )
                + ("null" if rowid2 is None else rowid2)
            ...
            if self.alt is not None:
                sql_updates = (
                    "null" if sql_updates is None else sql_updates
                ) + HxOverrides.stringOrNull(
                    ((("null" if rowid3 is None else rowid3) + " AS __coopy_rowid2,"))
                )
            else:
                sql_updates = (
                    "null" if sql_updates is None else sql_updates
            ...
            sql_updates = (
                ...
                (
                    (
                        (("null" if sql_dbl_cols is None else sql_dbl_cols) + " FROM ")
                        + ("null" if sql_table1 is None else sql_table1)
                    )
                )
            )
            ...
            sql_updates = (
                "null" if sql_updates is None else sql_updates
            ) + HxOverrides.stringOrNull(self.where(sql_data_mismatch))
            sql_updates_order = [
                "__coopy_code",
                "__coopy_rowid0",
                "__coopy_rowid1",
            ...
            if self.local is not None:
                sql_deletes = (
                    (
                        (
                            (
                                "SELECT DISTINCT 0 AS __coopy_code, "
                                + ("null" if rowid1 is None else rowid1)
                            )
                            + " AS rowid, NULL, NULL, "
                        )
                ...
                if self.remote is not None:
                    sql_deletes = (
                        "null" if sql_deletes is None else sql_deletes
                    ) + HxOverrides.stringOrNull(
                        (
                            (
                                " LEFT JOIN "
                        ...
                        (
                            (
                                (
                                    ...
                                    + (
                                        "null"
                                        if sql_key_match2 is None
                                        else sql_key_match2
                                    )
                                )
                                + HxOverrides.stringOrNull(self.where(sql_key_null2))
                            )
                        )
                    )
                if sql_table1 != sql_table2:
        ...
        if self.alt is not None:
            ...
            sql_deletes = ("null" if sql_deletes is None else sql_deletes) + (
                "null" if sql_dbl_cols is None else sql_dbl_cols
            )
            sql_deletes = (
                "null" if sql_deletes is None else sql_deletes
            ) + HxOverrides.stringOrNull(
                ((" FROM " + ("null" if sql_table1 is None else sql_table1)))
            )
            if self.remote is not None:
                sql_deletes = (
                    "null" if sql_deletes is None else sql_deletes
            ...
            sql_deletes = (
                "null" if sql_deletes is None else sql_deletes
            ) + " WHERE __coopy_rowid1 IS NULL OR __coopy_rowid2 IS NULL"
            sql_deletes_order = [
                "__coopy_code",
                "__coopy_rowid0",
                "__coopy_rowid1",
...
class SqlTable(object):
    ...
    def asTable(self):
        ...
        while _g < _g1:
            ...
            mt.setCell(
                i,
                0,
                (self.columnNames[x] if x >= 0 and x < len(self.columnNames) else None),
            )
            mt.setCell(
                i,
                1,
                (
                    self.columns[x] if x >= 0 and x < len(self.columns) else None
                ).type_value,
            )
            mt.setCell(
                i,
    ...
    def getRowStream(self):
        ...
        self.db.begin(
            (
                ("SELECT * FROM " + HxOverrides.stringOrNull(self.getQuotedTableName()))
                + " ORDER BY ?"
            ),
            [self.db.rowid()],
            self.columnNames,
    ...
    def fetchRow(self):
        if self.db.read():
            ...
            while _g < _g1:
                ...
                k = (
                    self.columnNames[i]
                    if i >= 0 and i < len(self.columnNames)
                    else None
                )
                v = self.db.get(i)
                row.h[k] = v
...
class SqlTableName(object):
    ...
    def toString(self):
        if self.prefix == "":
            return self.name
        return (HxOverrides.stringOrNull(self.prefix) + ".") + HxOverrides.stringOrNull(
            self.name
        )
...
class SqliteHelper(object):
    ...
    def countRows(self, db, name):
        q = "SELECT COUNT(*) AS ct FROM " + HxOverrides.stringOrNull(
            db.getQuotedTableName(name)
        )
    ...
    def getRowIDs(self, db, name):
        result = list()
        q = (
            "SELECT ROWID AS r FROM "
            + HxOverrides.stringOrNull(db.getQuotedTableName(name))
        ) + " ORDER BY ROWID"
    ...
    def update(self, db, name, conds, vals):
        q = (
            "UPDATE " + HxOverrides.stringOrNull(db.getQuotedTableName(name))
        ) + " SET "
        lst = list()
        k = vals.keys()
        while k.hasNext():
            ...
            q = ("null" if q is None else q) + HxOverrides.stringOrNull(
                db.getQuotedColumnName(k1)
            )
            q = ("null" if q is None else q) + " = ?"
    ...
    def delete(self, db, name, conds):
        q = (
            "DELETE FROM " + HxOverrides.stringOrNull(db.getQuotedTableName(name))
        ) + " WHERE "
        lst = list()
        k = conds.keys()
        while k.hasNext():
    ...
    def insert(self, db, name, vals):
        q = (
            "INSERT INTO " + HxOverrides.stringOrNull(db.getQuotedTableName(name))
        ) + " ("
        lst = list()
        k = vals.keys()
        while k.hasNext():
    ...
    def attach(self, db, tag, resource_name):
        ...
        if tag_present:
            if tag_correct:
                return True
            if not db.begin(
                (("DETACH `" + ("null" if tag is None else tag)) + "`"), None, []
            ):
                print(unicode(("Failed to detach " + ("null" if tag is None else tag))))
                return False
            db.end()
        if not db.begin(
            (("ATTACH ? AS `" + ("null" if tag is None else tag)) + "`"),
            [resource_name],
            [],
        ):
            print(
                unicode(
                    (
                        (
                            (
                                "Failed to attach "
                                + ("null" if resource_name is None else resource_name)
                            )
                            + " as "
                        )
                        + ("null" if tag is None else tag)
                    )
                )
            )
            return False
    ...
    def fetchSchema(self, db, name):
        ...
        query = "select sql from sqlite_master where name = " + (
            "null" if tname is None else tname
        )
        if not db.begin(query, None, ["sql"]):
            print(
                unicode(
                    (
                        "Cannot find schema for table "
                        + ("null" if tname is None else tname)
                    )
                )
            )
        ...
        while _g < _g1:
            ...
            if double_quote or single_quote:
                ...
                if single_quote:
                    if ch == "'":
                        single_quote = False
                token = ("null" if token is None else token) + (
                    "null" if ch is None else ch
                )
                continue
            brk = False
    ...
    def alterColumns(self, db, name, columns):
        ...
        while _g < _g1:
            ...
            if c.name is not None:
                ...
                if notBlank(next_type):
                    part = (
                        "null" if part is None else part
                    ) + HxOverrides.stringOrNull(
                        ((" " + ("null" if next_type is None else next_type)))
                    )
                if next_primary:
        ...
        tname = db.getQuotedTableName(name)
        if not self._hx_exec(
            db,
            (
                (
                    "CREATE TEMPORARY TABLE __coopy_backup("
                    + ("null" if c1 is None else c1)
                )
                + ")"
            ),
        ):
        ...
        if not self._hx_exec(
            ...
            return False
        if not self._hx_exec(
            db, ("DROP TABLE " + ("null" if tname is None else tname))
        ):
            return False
        if not self._hx_exec(
            db,
            (
                (
                    (HxOverrides.stringOrNull(schema.preamble) + "(")
                    + HxOverrides.stringOrNull(
                        ", ".join([python_Boot.toString1(x1, "") for x1 in nparts])
                    )
                )
                + ")"
            ),
            ...
            (
                (
                    (
                        (
                            (
                                ("INSERT INTO " + ("null" if tname is None else tname))
                                + " ("
                            )
                            + ("null" if c1 is None else c1)
                        )
...
class Std(object):
    ...
    def isOfType(v, t):
        ...
        if ((not isBool) and vIsFloat) and (t == Int):
            f = v
            tmp1 = (
                (f != Math.POSITIVE_INFINITY) and ((f != Math.NEGATIVE_INFINITY))
            ) and (not python_lib_Math.isnan(f))
        else:
            tmp1 = False
        if tmp1:
            tmp1 = None
        ...
        isEnumType = t == Enum
        if (isEnumType and python_lib_Inspect.isclass(v)) and hasattr(
            v, "_hx_constructs"
        ):
            return True
        if isEnumType:
        ...
        if (
            (
                (isClassType and (not isinstance(v, Enum)))
                and python_lib_Inspect.isclass(v)
            )
            and hasattr(v, "_hx_class_name")
        ) and (not hasattr(v, "_hx_constructs")):
            return True
        if isClassType:
            return False
        tmp = None
            ...
            while _g < _g1:
                ...
                if ((c > 8) and ((c < 14))) or ((c == 32)):
                    ...
                    if c1 == 43:
                        ...
                        if (previous == 48) and (
                            (
                                ((foundCount == 1) and ((sign == 0)))
                                or (((foundCount == 2) and ((sign != 0))))
                            )
                        ):
                            base = 16
                        elif not (((48 <= c) and ((c <= 57)))):
        ...
        while _g_offset < len(_g_s):
            ...
            if code1 == 34:
                if quotes:
                    ...
                    buf_b.write("".join(imap(unichr, [code])))
            elif code1 == 38:
                buf_b.write("&amp;")
            elif code1 == 39:
                if quotes:
...
class Sys(object):
    _hx_class_name = "Sys"
    __slots__ = ()
    _hx_statics = ["environ", "exit", "args", "getEnv", "command", "stdout", "stderr"]
    ...
    def command(cmd, args=None):
        if args is None:
            return python_lib_Subprocess.call(
                cmd,
                **python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({"shell": True}))
            )
        else:
...
class TableDiff(object):
                        ...
                        (
                            (
                                (
                                    txt.find(sep)
                                    if ((startIndex is None))
                                    else HxString.indexOfImpl(txt, sep, startIndex)
                                )
                            )
                            >= 0
                        )
        ...
        if (_hx_del > 0) and ((active is not None)):
            ...
            while _g < _g1:
                ...
                if (active[i] if i >= 0 and i < len(active) else None) == -3:
                    skips = skips + 1
                    continue
                if ((active[i] if i >= 0 and i < len(active) else None) == 0) or (
                    ((active[i] if i >= 0 and i < len(active) else None) == 3)
                ):
    ...
    def scanActivity(self):
        ...
        if not self.flags.show_unchanged:
            ...
            while _g < _g1:
                ...
                _g = _g + 1
                python_internal_ArrayImpl._set(
                    self.active_row, ((len(self.row_units) - 1) - i), 0
                )
        if not self.flags.show_unchanged_columns:
            ...
            while _g < _g1:
                ...
                unit = (
                    self.column_units[i]
                    if i >= 0 and i < len(self.column_units)
                    else None
                )
    ...
    def setupColumns(self):
        ...
        if ignore is not None:
            ...
            while _g < _g1:
                ...
                cunit = (
                    self.column_units[j]
                    if j >= 0 and j < len(self.column_units)
                    else None
                )
                if ((cunit.p in p_ignore.h) or (cunit.l in a_ignore.h)) or (
                    cunit.r in b_ignore.h
                ):
                    continue
    ...
    def scanSchema(self):
        ...
        while _g < _g1:
            ...
            _g = _g + 1
            cunit = (
                self.column_units[j] if j >= 0 and j < len(self.column_units) else None
            )
            reordered = False
            if self.flags.ordered:
            ...
            if (cunit.r < 0) and ((cunit.lp() >= 0)):
                ...
                if self.allow_column:
                    ...
                    _hx_local_3
            if (cunit.r >= 0) and ((cunit.lp() >= 0)):
                if (self.p.get_height() >= self.rp_header) and (
                    (self.b.get_height() >= self.rb_header)
                ):
                    ...
                    if not self.isEqual(self.v, pp, bb):
                        ...
                        act = "("
                        act = (
                            "null" if act is None else act
                        ) + HxOverrides.stringOrNull(self.v.toString(pp))
        ...
        if self.active_column is not None:
            ...
            while _g < _g1:
                ...
                if (
                    ...
                    if i >= 0 and i < len(self.active_column)
                    else None
                ) == 0:
                    all_active = False
                    break
        ...
        if self.have_schema:
            ...
            while _g < _g1:
                ...
                output.setCell(
                    ...
                    at,
                    self.v.toDatum(
                        (self.schema[j] if j >= 0 and j < len(self.schema) else None)
                    ),
                )
            ...
            while _g < _g1:
                ...
                if cunit.r >= 0:
                    if self.b.get_height() != 0:
                        output.setCell(
                            (j + 1), at, self.b.getCell(cunit.r, self.rb_header)
                        )
                elif cunit.l >= 0:
                    if self.a.get_height() != 0:
                        output.setCell(
                            (j + 1), at, self.a.getCell(cunit.l, self.ra_header)
                        )
                elif cunit.lp() >= 0:
                    if self.p.get_height() != 0:
                        output.setCell(
                            (j + 1), at, self.p.getCell(cunit.lp(), self.rp_header)
                        )
    ...
    def addMeta(self, output):
        ...
        meta_align = Coopy.compareTables3(
            (None if ((a_meta == p_meta)) else p_meta), a_meta, b_meta, meta_flags
        ).align()
        ...
        if td.hasDifference() or td.hasSchemaDifference():
            ...
            while _g < _g1:
                ...
                while _g2 < _g3:
                    ...
                    if x == 1:
                        c = (
                            ("@" + HxOverrides.stringOrNull(v.toString(c))) + "@"
                        ) + HxOverrides.stringOrNull(
                            v.toString(meta_diff.getCell(0, y))
                        )
            ...
            if self.active_column is not None:
                if len(td.active_column) == meta_diff.get_width():
                    ...
                    while _g < _g1:
                        ...
                        if (
                            td.active_column[i]
                            if i >= 0 and i < len(td.active_column)
                            else None
                        ) >= 0:
                            python_internal_ArrayImpl._set(
                                self.active_column, (i - 1), 1
                            )
        return False

    def refineActivity(self):
        self.spreadContext(
            self.row_units, self.flags.unchanged_context, self.active_row
        )
        self.spreadContext(
            self.column_units, self.flags.unchanged_column_context, self.active_column
        )
        if self.active_column is not None:
            _g = 0
            _g1 = len(self.column_units)
        ...
        if self.flags.ignore_epsilon > 0:
            ...
            if not python_lib_Math.isnan(fa):
                ...
                if not python_lib_Math.isnan(fb):
                    if (
                        Reflect.field(Math, "fabs")((fa - fb))
                        < self.flags.ignore_epsilon
                    ):
                        return True
    ...
    def checkNesting(self, v, have_ll, ll, have_rr, rr, have_pp, pp, x, y):
        ...
        rr_out = None
        pp_out = None
        if (comp.alignment.isMarkedAsIdentical() or ((have_ll and (not have_rr)))) or (
            (have_rr and (not have_ll))
        ):
    ...
    def scanRow(self, unit, output, at, i, out):
        ...
        while _g < _g1:
            ...
            if self.nested:
                ndiff = self.checkNesting(
                    self.v, have_ll, ll, have_rr, rr, have_pp, pp, i, j
                )
            ...
            cell = dd
            if have_dd_to and (
                (((dd is not None) and self.allow_update) or self.allow_column)
            ):
                if not row_update:
                    if out == 0:
                        _hx_local_0 = self
                ...
                if not is_conflict:
                    ...
                    if self.conflict_sep == "":
                        if self.builder.needSeparator():
                            self.conflict_sep = HxOverrides.stringOrNull(
                                self.getSeparator(self.p, self.a, "!")
                            ) + HxOverrides.stringOrNull(self.sep)
            ...
            if self.act == "+++":
                if have_rr:
                    if self.active_column is not None:
                        python_internal_ArrayImpl._set(self.active_column, j, 1)
            if self.publish:
                if (self.active_column is None) or (
                    (
                        (
                            self.active_column[j]
                            if j >= 0 and j < len(self.active_column)
                            else None
                        )
                        > 0
                    )
        ...
        while _g < _g1:
            ...
            while _g2 < _g3:
                ...
                if out == 1:
                    value = (
                        self.active_row[i]
                        if i >= 0 and i < len(self.active_row)
                        else None
                    )
                ...
                if ((unit.p < 0) and ((unit.l < 0))) and ((unit.r >= 0)):
                    ...
                    if (out == 0) and (not skip):
                        ...
                        _hx_local_5
                if (
                    (((unit.p >= 0) or (not self.has_parent))) and ((unit.l >= 0))
                ) and ((unit.r < 0)):
    ...
    def getSummary(self):
        ...
        ds.row_count_initial = (
            self.align.getSource().get_height() - self.align.getSourceHeader()
        ) - 1
        ds.row_count_final = (
            self.align.getTarget().get_height() - self.align.getTargetHeader()
        ) - 1
                ...
                (
                    (
                        (
                            (
                                (
                                    (self.row_deletes + self.row_inserts)
                                    + self.row_updates
                                )
                                + self.row_reorders
                            )
...
class TableStream(object):
    ...
    def getCell(self, x):
        ...
        if self.row is not None:
            return self.row.h.get(
                (self.columns[x] if x >= 0 and x < len(self.columns) else None), None
            )
...
class Tables(object):
    ...
    def one(self):
        return self.tables.h.get(
            (self.table_order[0] if 0 < len(self.table_order) else None), None
        )
...
class TerminalDiffRender(object):
    ...
    def getText(self, x, y, color):
        ...
        if color and self.diff:
            ...
            if code is not None:
                separator = (
                    cell.pretty_separator if (self.use_glyphs) else cell.separator
                )
                if cell.rvalue is not None:
                        ...
                        (
                            (
                                (
                                    (
                                        HxOverrides.stringOrNull(
                                            self.codes.h.get("remove", None)
                                        )
                                        + HxOverrides.stringOrNull(cell.lvalue)
                                    )
                                    + HxOverrides.stringOrNull(
                                        self.codes.h.get("modify", None)
                                    )
                                )
                                + ("null" if separator is None else separator)
                            )
                            + HxOverrides.stringOrNull(self.codes.h.get("add", None))
                        )
                        + HxOverrides.stringOrNull(cell.rvalue)
                    ) + HxOverrides.stringOrNull(self.codes.h.get("done", None))
                    if cell.pvalue is not None:
                        val = (
                            (
                                (
                                    HxOverrides.stringOrNull(
                                        self.codes.h.get("conflict", None)
                                    )
                                    + HxOverrides.stringOrNull(cell.pvalue)
                                )
                                + HxOverrides.stringOrNull(
                                    self.codes.h.get("modify", None)
                                )
                    ...
                    val = (
                        ("null" if code is None else code) + Std.string(val)
                    ) + HxOverrides.stringOrNull(self.codes.h.get("done", None))
        elif color and (not self.diff):
            if y == 0:
                val = (
                    HxOverrides.stringOrNull(self.codes.h.get("header", None))
                    + Std.string(val)
                ) + HxOverrides.stringOrNull(self.codes.h.get("done", None))
        else:
            val = cell.pretty_value if (self.use_glyphs) else cell.value
...
class Type(object):
    ...
    def getClass(o):
        if o is None:
            return None
        o1 = o
        if (o1 is not None) and (
            (HxOverrides.eq(o1, unicode) or python_lib_Inspect.isclass(o1))
        ):
            return None
...
class Unit(object):
    ...
    def toString(self):
        if self.p >= -1:
            return (
                (
                    (HxOverrides.stringOrNull(Unit.describe(self.p)) + "|")
                    + HxOverrides.stringOrNull(Unit.describe(self.l))
                )
                + ":"
            ) + HxOverrides.stringOrNull(Unit.describe(self.r))
        return (
            HxOverrides.stringOrNull(Unit.describe(self.l)) + ":"
        ) + HxOverrides.stringOrNull(Unit.describe(self.r))
    ...
    def base26(self, num):
        ...
        while True:
            ...
            out = ("null" if out is None else out) + HxOverrides.stringOrNull(
                ("" if (((index < 0) or ((index >= len(alpha))))) else alpha[index])
            )
    ...
    def toBase26String(self):
        if self.p >= -1:
            return (
                (
                    (HxOverrides.stringOrNull(self.base26(self.p)) + "|")
                    + HxOverrides.stringOrNull(self.base26(self.l))
                )
                + ":"
            ) + HxOverrides.stringOrNull(self.base26(self.r))
        return (
            HxOverrides.stringOrNull(self.base26(self.l)) + ":"
        ) + HxOverrides.stringOrNull(self.base26(self.r))
...
class Viterbi(object):
    ...
    def addTransition(self, s0, s1, c):
        ...
        if self.index > 0:
            ...
            sourced = True
        if sourced:
            if (c < self.cost.get(s1, self.index)) or (
                (self.src.get(s1, self.index) == -1)
            ):
    ...
    def calculatePath(self):
        ...
        while _g < _g1:
            j = _g
            _g = _g + 1
            if (((self.cost.get(j, (self.index - 1)) < best) or ((bestj == -1)))) and (
                (self.src.get(j, (self.index - 1)) != -1)
            ):
...
class haxe_Exception(Exception):
    ...
    __slots__ = (
        "_hx___nativeStack",
        "_hx___skipStack",
        "_hx___nativeException",
        "_hx___previousException",
    )
    _hx_fields = [
        "__nativeStack",
        "__skipStack",
...
class haxe_format_JsonPrinter(object):
        ...
        if tmp == 0:
            ...
            if c == unicode:
                ...
                while _g1 < _g2:
                    ...
                    if self.pretty:
                        _this1 = self.buf
                        s1 = "".join(imap(unichr, [10]))
                        _this1.b.write(s1)
                    if self.pretty:
                        v2 = StringTools.lpad(
                            "", self.indent, (self.nind * len(self.indent))
                        )
                        _this2 = self.buf
                        s2 = Std.string(v2)
                        _this2.b.write(s2)
                ...
                while k.hasNext():
                    ...
                    setattr(
                        ...
                        (
                            ("_hx_" + k1)
                            if ((k1 in python_Boot.keywords))
                            else (
                                ("_hx_" + k1)
                                if (
                                    (
                                        (
                                            ((len(k1) > 2) and ((ord(k1[0]) == 95)))
                                            and ((ord(k1[1]) == 95))
                                        )
                                        and ((ord(k1[(len(k1) - 1)]) != 95))
                                    )
                                )
                                else k1
                            )
    ...
    def fieldsString(self, v, fields):
        ...
        while _g < _g1:
            ...
            self.quote(f)
            _this3 = self.buf
            s3 = "".join(imap(unichr, [58]))
            _this3.b.write(s3)
            if self.pretty:
                _this4 = self.buf
                s4 = "".join(imap(unichr, [32]))
                _this4.b.write(s4)
            self.write(f, value)
            if i == last:
                _hx_local_2 = self
                ...
                if self.pretty:
                    ...
                    _this6.b.write(s6)
        _this = self.buf
        s = "".join(imap(unichr, [125]))
        _this.b.write(s)

    def quote(self, s):
        _this = self.buf
        s1 = "".join(imap(unichr, [34]))
        _this.b.write(s1)
        i = 0
        while True:
            index = i
            ...
            if c1 == 8:
                ...
                _this = self.buf
                s1 = "".join(imap(unichr, [c]))
                _this.b.write(s1)
        _this = self.buf
        s = "".join(imap(unichr, [34]))
        _this.b.write(s)
...
class haxe_iterators_ArrayKeyValueIterator(object):
    ...
    def next(self):
        def _hx_local_3():
            ...
            return _hx_AnonObject(
                {
                    "value": python_internal_ArrayImpl._get(self.array, self.current),
                    "key": _hx_local_2(),
                }
            )
        ...
        if hasattr(o, "__class__"):
                ...
                if hasParams:
                    ...
                    while _g < _g1:
                        ...
                        if i > 0:
                            prefix = ","
                        paramsStr = (
                            "null" if paramsStr is None else paramsStr
                        ) + HxOverrides.stringOrNull(
                            (
                                (
                                    ("null" if prefix is None else prefix)
                                    + HxOverrides.stringOrNull(
                                        python_Boot.toString1(o1.params[i], s)
                                    )
                                )
                            )
                        )
                    return (
                        (HxOverrides.stringOrNull(o1.tag) + "(")
                        + ("null" if paramsStr is None else paramsStr)
                    ) + ")"
                else:
                    return o1.tag
            if hasattr(o, "_hx_class_name"):
                if o.__class__.__name__ != "type":
                    ...
                    fieldsStr = _g
                    toStr = (
                        (HxOverrides.stringOrNull(o._hx_class_name) + "( ")
                        + HxOverrides.stringOrNull(", ".join([x1 for x1 in fieldsStr]))
                    ) + " )"
                    return toStr
                else:
        ...
        field1 = (
            ...
            if ((field in python_Boot.keywords))
                ...
                if (
                    (
                        (
                            ((len(field) > 2) and ((ord(field[0]) == 95)))
                            and ((ord(field[1]) == 95))
                        )
                        and ((ord(field[(len(field) - 1)]) != 95))
                    )
                )
                else field
            )
            ...
            if _hx_local_1 == 11:
                if field1 == "lastIndexOf":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.lastIndexOf
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "copy":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.copy
                    )
                elif field1 == "join":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.join
                    )
                elif field1 == "push":
                    return python_internal_MethodClosure(
                    ...
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.sort
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "shift":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.shift
                    )
                elif field1 == "slice":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.slice
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "indexOf":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.indexOf
                    )
                elif field1 == "reverse":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.reverse
                    )
                elif field1 == "unshift":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.unshift
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "map":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.map
                    )
                elif field1 == "pop":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.pop
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "contains":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.contains
                    )
                elif field1 == "iterator":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.iterator
                    )
                elif field1 == "toString":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.toString
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "keyValueIterator":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.keyValueIterator
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
                ...
                if field1 == "concat":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.concat
                    )
                elif field1 == "filter":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.filter
                    )
                elif field1 == "insert":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.insert
                    )
                elif field1 == "length":
                    return len(o)
                elif field1 == "remove":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.remove
                    )
                elif field1 == "splice":
                    return python_internal_MethodClosure(
                        o, python_internal_ArrayImpl.splice
                    )
                else:
                    field1 = (
                        ("_hx_" + field)
...
class python_internal_ArrayImpl(object):
    ...
    def lastIndexOf(a, x, fromIndex=None):
        ...
        l = (
            _hx_len
            if ((fromIndex is None))
            else (((_hx_len + fromIndex) + 1) if ((fromIndex < 0)) else (fromIndex + 1))
        )
        if l > _hx_len:
            l = _hx_len
        while True:
    ...
    def toString(x):
        return (
            "["
            + HxOverrides.stringOrNull(
                ",".join([python_Boot.toString1(x1, "") for x1 in x])
            )
        ) + "]"
...
class HxString(object):
    ...
    def lastIndexOf(s, _hx_str, startIndex=None):
        if startIndex is None:
            ...
            startLeft = (
                max(0, ((startIndex + 1) - len(_hx_str))) if ((i == -1)) else (i + 1)
            )
...
class python_io_NativeTextOutput(python_io_NativeOutput):
    ...
    def writeByte(self, c):
        self.stream.write("".join(imap(unichr, [c])))
...
class SqliteDatabase(SqlDatabase):
    ...
    def beginRow(self, tab, row, order=[]):
        self.cursor.execute(
            "SELECT * FROM " + self.getQuotedTableName(tab) + " WHERE rowid = ?", [row]
        )
        return True
...
def get_stdout():
    return (
        python_lib_Sys.stdout.buffer
        if hasattr(python_lib_Sys.stdout, "buffer")
        else python_lib_Sys.stdout
    )


def stream_write(s):
    return lambda txt: (
        s.buffer.write(txt) if hasattr(s, "buffer") else (s.write(txt) or len(txt))
    )
